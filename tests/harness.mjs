...
export function harness(markup = '', config = {}) {
  ...
  const modules = dom.window.eval(`${source}\n({ createJsonRequest, createTorrentRepository, createTorrentNaming, createTorrentDropdowns, createLiveTorrentIcons, renderMediaSummary, renderTorrentDropdown, enhanceSearchTorrentDropdowns, gazellifyTorrentLayout })`);
